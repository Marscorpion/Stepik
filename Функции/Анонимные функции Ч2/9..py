...
# print(max(mixed_list, key=lambda x: x == 0 if isinstance(x, str) else x))

# print(max(filter(lambda c: type(c) is int, mixed_list)))

# print(max(mixed_list, key=lambda x: x == 0 if type(x) == str else x))
